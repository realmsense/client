...
// il2cpp
#define OFFSET_IL2CPP_STRING_NEW                0x1fca00  // il2cpp_string_new
...
#define OFFSET_ENTITY_UPDATE                    0xe5a1d0    // COEDKELBKMI.(HOGFGOPEKAE or FFHEDOAINJH) - Random method to get enemy 
#define OFFSET_PET_UPDATE                       0x916bc0    // DAFEAHGLBGL.AOOJCNNGNGI - random method that runs every tick to get pets

// mscorlib.dll
#define OFFSET_SYSTEM_GET_TYPE                  0x2de00b0   // System.Type.GetType
...
#define OFFSET_TMP_TEXT_SET_TEXT_INTERNAL       0x7d2f80    // TMPro.TMP_Text.set_text (String*)

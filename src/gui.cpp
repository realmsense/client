...
HRESULT __stdcall Detour_Present(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
    ...
    //// view is first
    ////ModuleCategory current_category = ModuleCategory::VIEW;
    //
    //std::vector<Module*> modules = GetAllModules();
    //for (auto module : modules)
    //{
    //    static int current_category = (int)module->category;
    //    const char* module_name = module_names[current_category];
    //
    //    if (current_category == 0)
    //        ImGui::Begin(module_name);
    //
    //    if ((int)module->category != current_category)
    //    {
    //        ImGui::End();
    //        ImGui::Begin(module_name);
    //    }
    ...
    //
    //    //if ((int)module->category != (int)current_category)
    //    //{
    //    //    ImGui::End();
    //    //
    //    //    const char* module_name = module_names[(int)current_category];
    //    //    ImGui::Begin(module_name);
    //    //}
    //
    //    //ImGui::Text(module->name.c_str());
    //    //ImGui::SameLine();
    //    //const char* module_name = module_names[(int)module->category];
    //    //ImGui::Text(module_name);
    //
    //    // if module->category is different then end render

...
typedef void(__cdecl* _ShowFloatingText)(uintptr_t MapObjectUIManager, FloatingTextType type, String* str, __int64 color, float holdTime); // OFFSET_SHOW_FLOATING_TEXT
...
typedef bool(__cdecl* _Input_GetKey)(int keyCode);                                                        // OFFSET_GET_KEY_DOWN, OFFSET_GET_KEY

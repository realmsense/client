...
struct EntityManager__StaticFields {
    struct ProfilerMarker k_ProfileMoveSharedComponents;
    struct ProfilerMarker k_ProfileMoveManagedComponents;
};

struct EntityManager__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct EntityManager__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct EntityManager__VTable vtable;
};
...
struct LAAIPMHLFJN__Fields {
    struct GJLIMCBOCJG__Fields _;
    struct LAAIPMHLFJN_OHFEFBLKENE *GCADFJIJILJ;
    struct LAAIPMHLFJN_DONNNAHFHFL *ONFIGLJIIKE;
    struct LAAIPMHLFJN_DONNNAHFHFL *IBLNHFPBLCJ;
    struct LAAIPMHLFJN_DONNNAHFHFL *HHAJNDJDEHF;
    struct LAAIPMHLFJN_DONNNAHFHFL *ECDIDHKLCOB;
    struct LAAIPMHLFJN_DONNNAHFHFL *JCOMFCKCNIM;
    struct LAAIPMHLFJN_CKABBMAGJCF *KOHAEPMPCPE;
    ...
    int32_t CKLDGPCPDJJ;
    #if defined(_CPLUSPLUS_)
    EFBAFDICAFG__Enum MBLPMJAIBBJ;
    #else
    int32_t MBLPMJAIBBJ;
    #endif
    bool BDNEAINFICG;
    #if defined(_CPLUSPLUS_)
    BJHJLINJFAI__Enum EHLAPMNLCFD;
    #else
    int32_t EHLAPMNLCFD;
    #endif
...
struct LAAIPMHLFJN {
    struct LAAIPMHLFJN__Class *klass;
    MonitorData *monitor;
    struct LAAIPMHLFJN__Fields fields;
};

struct COEDKELBKMI__Fields {
    struct LAAIPMHLFJN__Fields _;
...
struct COEDKELBKMI {
    struct COEDKELBKMI__Class *klass;
    MonitorData *monitor;
    struct COEDKELBKMI__Fields fields;
};
...
struct JFNHHLNJJKP__Fields {
    struct COEDKELBKMI__Fields _;
    struct JFNHHLNJJKP_MLMCBBKGONG *FCIEBGPMHNK;
    struct JFNHHLNJJKP_MLMCBBKGONG *KPPKMGPOFNP;
    struct JFNHHLNJJKP_MLMCBBKGONG *LHPMIHBOOPM;
    struct JFNHHLNJJKP_MLMCBBKGONG *FCIHLFOKMFN;
    struct JFNHHLNJJKP_MLMCBBKGONG *NBDOMFJHELN;
    struct JFNHHLNJJKP_MLMCBBKGONG *NANBJLEJJPI;
    struct JFNHHLNJJKP_MLMCBBKGONG *AADHLIGDDPL;
    struct JFNHHLNJJKP_MLMCBBKGONG *IAOPCPHBDFC;
    struct JFNHHLNJJKP_MLMCBBKGONG *KJHAPJGCDNK;
    struct JFNHHLNJJKP_MLMCBBKGONG *GHFPMFOKBLK;
    struct JFNHHLNJJKP_MLMCBBKGONG *GJPKDPMOEPD;
    struct JFNHHLNJJKP_MLMCBBKGONG *JLDIILNLHIK;
    struct JFNHHLNJJKP_MLMCBBKGONG *PJEDNBPDHDE;
    struct JFNHHLNJJKP_MLMCBBKGONG *KOEHHFOIHLD;
    struct JFNHHLNJJKP_MLMCBBKGONG *FEMLKOBJCKP;
    struct JFNHHLNJJKP_MLMCBBKGONG *AFANALBKNKG;
    struct JFNHHLNJJKP_MLMCBBKGONG *PLJMHFJLMFA;
    struct JFNHHLNJJKP_GEBIFPOPIIN *HEHKHJGBCIJ;
    ...
    float INENFAFGICA;
    float IGCIKJFPBOF;
    struct DAFEAHGLBGL *GPMIPLJHOKI;
...
struct JFNHHLNJJKP {
    struct JFNHHLNJJKP__Class *klass;
    MonitorData *monitor;
...
struct __declspec(align(8)) KFAICNFFPBF__Fields {
    ...
    int32_t BBHHKMOIELH;
    int32_t JHCDIFDCBCD;
    struct ObjectProperties *NLODPDOFMKB;
    struct JAGDKKOFPKN *KCEJNKJMPIE;
    struct String *HHAAMEHHGGP;
    int32_t PILKMJHMHGJ;
    struct FCLEGHHJDNG__Array *GICILMECLGF;
    bool FODIHJDPGHG;
    int32_t PEIJKHIDMNG;
};

struct KFAICNFFPBF {
    struct KFAICNFFPBF__Class *klass;
    MonitorData *monitor;
    struct KFAICNFFPBF__Fields fields;
};
...
struct JILKFLHPEGF {
    struct JILKFLHPEGF__Class *klass;
    MonitorData *monitor;
};

struct __declspec(align(8)) BGBHFKICMIM__Fields {
    struct BGBHFKICMIM_DPONBLJNOHB *FIIGACENCCM;
    struct BGBHFKICMIM_DPONBLJNOHB *PLDDGMANKBA;
    struct BGBHFKICMIM_KAGPNDNCNCA *MEPMDOCHEHJ;
    struct BGBHFKICMIM_KAGPNDNCNCA *DHAKGGIAOHI;
    struct Dictionary_2_System_Int32_KFAICNFFPBF_ *INPEEPCHJAC;
    struct List_1_KFAICNFFPBF_ *DNGEIMDIEAO;
    struct Dictionary_2_System_Int32_BCOGMGJEHMO_ *HPLBCKIOPJP;
    struct Dictionary_2_System_String_List_1_BCOGMGJEHMO_ *EDOMNDDOFNA;
    struct List_1_System_Int32_ *EOABKEAGOJI;
    struct KFAICNFFPBF *HMLEONMOKBC;
    struct HCLAMODFNBI *LPKIADKODHC;
    struct SocketManager_1 *HPIPJDMLKLK;
    int32_t LBPJDLKNBDJ;
    struct ObjectProperties *JHIHOPKIKGL;
    int32_t MLAPFFPMJAF;
    struct OIJHCOJFHHM *_NIGNBIMDGOL_k__BackingField;
    struct IOHPGOFBNGD *_LNDFPOBMLHH_k__BackingField;
};

struct BGBHFKICMIM {
    struct BGBHFKICMIM__Class *klass;
    MonitorData *monitor;
...
struct NIIFJAMEHDD__Array {
    struct NIIFJAMEHDD__Array__Class *klass;
    MonitorData *monitor;
    Il2CppArrayBounds *bounds;
    il2cpp_array_size_t max_length;
    struct NIIFJAMEHDD *vector[32];
};

struct DAFEAHGLBGL__Fields {
    struct NIIFJAMEHDD__Fields _;
    struct KFAICNFFPBF *GFKKAPGKPDP;
    int32_t PHNLNOOLAIO;
    bool OBKOMAKIAAB;
    struct ObjectProperties *FGPKMNEABHD;
    struct ObjectProperties *BKHBOCPPAOM;
    struct ObjectProperties *NBEJOKEADNJ;
    bool INBKGJMLAKI;
    struct JFNHHLNJJKP *KCKGPAMMOOD;
    bool MCNLCNGGFAP;
    bool FOIHFCCDDBD;
...
struct DAFEAHGLBGL {
    struct DAFEAHGLBGL__Class *klass;
    MonitorData *monitor;
    struct DAFEAHGLBGL__Fields fields;
};

struct KFAICNFFPBF__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
    VirtualInvokeData DMDLPGGKHNL;
    VirtualInvokeData LOKKJADIDEB;
    VirtualInvokeData BHABHCIBCHN;
    VirtualInvokeData EOEGLNEPCCG;
    VirtualInvokeData JOLNFAHGPLJ;
    VirtualInvokeData LLCOBMDPHCA;
    VirtualInvokeData OKAIBOMPPFE;
    VirtualInvokeData CKFLPNIKNHG;
    VirtualInvokeData HBOMJCOEIOK;
    VirtualInvokeData BDKPIKOHBJG;
    VirtualInvokeData GDEMMBAPMNJ;
    VirtualInvokeData HEJMKCOGJID;
    VirtualInvokeData KJGOMONEGGJ;
    VirtualInvokeData FMFCAFNFKNC;
    VirtualInvokeData NIPIMCNCOGN;
    VirtualInvokeData OMACIFIAGEC;
    VirtualInvokeData HDDKMMEHBID;
    VirtualInvokeData JGNJOHAGHIP;
    VirtualInvokeData PNKBJFMDHJP;
    VirtualInvokeData FKKGNGGBFBK;
    VirtualInvokeData MIJKMJAKGOB;
    VirtualInvokeData CBPBGKIKHBD;
};

struct KFAICNFFPBF__StaticFields {
};

struct KFAICNFFPBF__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct KFAICNFFPBF__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
...
struct PHFEMIPMDEK__StaticFields {
};

struct PHFEMIPMDEK__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct PHFEMIPMDEK__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
...
struct JILKFLHPEGF__VTable {
    VirtualInvokeData BLLKHFIAAGI;
    VirtualInvokeData BBLFEAFHJKH;
    VirtualInvokeData ELNCEMGIIND;
    VirtualInvokeData EJBGEINNEBC;
    VirtualInvokeData CNJNPCBLJCE;
    VirtualInvokeData COFINGEKPCF;
    VirtualInvokeData NDAHNKAJJFO;
    VirtualInvokeData HBJDLKIAHBE;
    VirtualInvokeData KDMIIEIFNPI;
    VirtualInvokeData EGGIBLMIHON;
    VirtualInvokeData GKGEJMCFPHI;
    VirtualInvokeData EHPALHBDILK;
    VirtualInvokeData BHPBLAEANLH;
    VirtualInvokeData HLEELDJDJEC;
    VirtualInvokeData KOALKPIIHLC;
};

struct JILKFLHPEGF__StaticFields {
};

struct JILKFLHPEGF__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct JILKFLHPEGF__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct JILKFLHPEGF__VTable vtable;
};

struct BGBHFKICMIM__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct BGBHFKICMIM__StaticFields {
    int32_t ANHBLIECNDL;
    int32_t BCBEJHFOJPH;
    int32_t DLCIPFPGBMP;
    int32_t KKEEJNFKBCF;
...
struct BGBHFKICMIM__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct BGBHFKICMIM__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
...
struct NIIFJAMEHDD__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
    VirtualInvokeData OOFAOFPHFMJ;
    VirtualInvokeData LGPMLBPBBGI;
    VirtualInvokeData JNPIINILNNC;
    VirtualInvokeData JONCCEGNKPE;
    VirtualInvokeData PKONCPDLHFA;
    VirtualInvokeData AIPMKILNFKM;
    VirtualInvokeData NLFFGMBAKKG;
    VirtualInvokeData FNMLMILBFGL;
    VirtualInvokeData HNFHENMCPCA;
    VirtualInvokeData LICJFLMNBAO;
    VirtualInvokeData HGHKMKAEFHI;
    VirtualInvokeData ICGCOKMEJDN;
    VirtualInvokeData ELALCNBFHDB;
    VirtualInvokeData GILLGBFOMHL;
    VirtualInvokeData IFLHDNLBJLN;
    VirtualInvokeData LBGKNMJKLBC;
    VirtualInvokeData ELGNOMMKNFA;
    VirtualInvokeData DNEFHGFKNCG;
    VirtualInvokeData CPALELPDKJH;
    VirtualInvokeData KHADPGKBMEG;
    VirtualInvokeData NHGCICGJGLP;
    VirtualInvokeData GIPMPEIMGHP;
    VirtualInvokeData GPIMPPOPDJO;
    VirtualInvokeData OPGMDIFIIEN;
    VirtualInvokeData CPCDBAOEPLC;
    VirtualInvokeData DGGHGLIIHGA;
    VirtualInvokeData GNMLFCLAAFP;
    VirtualInvokeData KFGFDKBGEPL;
    VirtualInvokeData CIMLKGACMBI;
    VirtualInvokeData OKDDGFOJJBE;
    VirtualInvokeData MGHGEDJFKAA;
    VirtualInvokeData OGCOBMAEKJP;
    VirtualInvokeData CCLBGDJLKGN;
    VirtualInvokeData HAEODKNPNLN;
    VirtualInvokeData PLJPFJOGABO;
    VirtualInvokeData HENJABPMBCF;
    VirtualInvokeData IMHNOMGBEJL;
    VirtualInvokeData EENJHLFFKCO;
    VirtualInvokeData MPDHAGEGLGK;
    VirtualInvokeData FJKKFNHLGBC;
    VirtualInvokeData CDKKNNAJIBG;
    VirtualInvokeData KPILPHGBNDD;
    VirtualInvokeData KGDCDMJOEOK;
    VirtualInvokeData JDPDMBNLBHP;
    VirtualInvokeData LCOGFAPEOMA;
    VirtualInvokeData IJGJMPEHNGC;
    VirtualInvokeData LICJFLMNBAO_1;
    VirtualInvokeData JOOGIPKNGLL;
    VirtualInvokeData MJFJELLFIJO;
    VirtualInvokeData CHMAIHEMAOH;
    VirtualInvokeData PLMHCNHIEEE;
    VirtualInvokeData OKNHHLHAFBB;
    VirtualInvokeData CGAEFBIHOOI;
    VirtualInvokeData JIPBJJFCNLI;
    VirtualInvokeData FAIHGPEKFIL;
    VirtualInvokeData ABPNAIJOIGB;
    VirtualInvokeData FBCADFDONLJ;
    VirtualInvokeData LONNLHMFGAE;
    VirtualInvokeData IEAJDJAAAOO;
    VirtualInvokeData NBCLDIIAPLC;
    VirtualInvokeData AGHGIPDHCDF;
    VirtualInvokeData FJEHPNMEBCO;
    VirtualInvokeData AILENABHIPL;
    VirtualInvokeData HOGFGOPEKAE;
    VirtualInvokeData FDNIHBJHOEK;
    VirtualInvokeData CEJGIDBDBON;
    VirtualInvokeData CNIHKIHPEJA;
    VirtualInvokeData EIIJHNDDIGM;
    VirtualInvokeData LHGNFNGILMG;
    VirtualInvokeData NGMBEADLMFC;
    VirtualInvokeData DAFFFIKALHA;
    VirtualInvokeData KIIMLBIMDCD;
    VirtualInvokeData IPEBBJBGDNH;
    VirtualInvokeData HAKPCCFAENP;
    VirtualInvokeData NCJKMPCFPHC;
    VirtualInvokeData GLMLCPONFPF;
    VirtualInvokeData JHFFMLNEBPO;
    VirtualInvokeData PBFCCBNEPBJ;
    VirtualInvokeData KOBJNFBMICI;
    VirtualInvokeData NCJMINHPDLN;
    VirtualInvokeData AOLGMCDAEAC;
    VirtualInvokeData IANHFBKKKKG;
    VirtualInvokeData LHBACFANDBM;
    VirtualInvokeData CKDMJAOHLJA;
    VirtualInvokeData LJIMLAEKDFD;
    VirtualInvokeData ONGENDLNDFP;
    VirtualInvokeData JEGECFEDDNI;
    VirtualInvokeData GKGLNGPGLND;
    VirtualInvokeData IHPGBHNFGNE;
    VirtualInvokeData ABNGPIDBFKP;
    VirtualInvokeData MBLFNILDEND;
    VirtualInvokeData OCMLDAJPHPM;
    VirtualInvokeData EGNAPMHMJEC;
    VirtualInvokeData IFMEPIOMCEA;
    VirtualInvokeData DPDIKIHDGLF;
    VirtualInvokeData GEHNNKANEFI;
    VirtualInvokeData IMFEKGDPBFI;
    VirtualInvokeData JDLCNBGHIHD;
    VirtualInvokeData LKFJOBDOFAP;
    VirtualInvokeData PJNBGPNKPAC;
    VirtualInvokeData EANNHELEGHB;
    VirtualInvokeData IHBPLKPPMJC;
    VirtualInvokeData BOEOPPAAGJF;
    VirtualInvokeData IMKMLFMJCOE;
    VirtualInvokeData AMBFFEFGGIL;
    VirtualInvokeData JHPGOJHLBIK;
    VirtualInvokeData FPIOIDEAGCA;
    VirtualInvokeData IMOOPAIAOOD;
    VirtualInvokeData BNDCNGKCGBC;
    VirtualInvokeData GCDDOFPJLHN;
    VirtualInvokeData NGEBDJBEMKA;
    VirtualInvokeData IPNNLHCMECP;
    VirtualInvokeData PLMIBLPPOFP;
    VirtualInvokeData MCAIMOMFGNP;
    VirtualInvokeData CLLJHNKOKDH;
    VirtualInvokeData FIPAOLJMNOP;
    VirtualInvokeData GJOHCLJINJK;
    VirtualInvokeData DNLAEMDJPML;
    VirtualInvokeData ICMJCJNPBAB;
    VirtualInvokeData HCDMLPOCDLD;
    VirtualInvokeData CADFHJLMKFA;
    VirtualInvokeData PPPMCEMCDOB;
    VirtualInvokeData JAKAIKGHPEI;
    VirtualInvokeData BJKGNMDAHEP;
    VirtualInvokeData IAHCPJFOIGF;
    VirtualInvokeData AIPHLGKCMIL;
    VirtualInvokeData NPLFADBGBHH;
    VirtualInvokeData GNCKGHGBIEH;
    VirtualInvokeData BAJNKEBJDHP;
    VirtualInvokeData ENAIIHANCAO;
    VirtualInvokeData MCCIMLCOHED;
    VirtualInvokeData CCNOPONCBKK;
    VirtualInvokeData JNCJEFMDPCO;
    VirtualInvokeData EIILAPJGEAJ;
    VirtualInvokeData AHBOIFCFLJE;
    VirtualInvokeData CHOLJKHJIBH;
    VirtualInvokeData CLOHKEFKAOK;
    VirtualInvokeData BOKAEBAEMHF;
    VirtualInvokeData FGIMFPOACAC;
    VirtualInvokeData AOOJCNNGNGI;
    VirtualInvokeData BLLKHFIAAGI;
    VirtualInvokeData BBLFEAFHJKH;
    VirtualInvokeData ELNCEMGIIND;
    VirtualInvokeData EJBGEINNEBC;
    ...
    VirtualInvokeData HLEELDJDJEC;
    VirtualInvokeData KOALKPIIHLC;
    VirtualInvokeData JGLEDIFEJDD;
    VirtualInvokeData DGBPHCDMJKC;
    VirtualInvokeData KJBLGPKLPKG;
    VirtualInvokeData HBJDLKIAHBE_1;
    VirtualInvokeData HPAKLLOKKNH;
    VirtualInvokeData AGHNNPJMHIP;
    VirtualInvokeData BMLGCGCJLPP;
    VirtualInvokeData GFPMPCLFEDF;
    VirtualInvokeData CLKDCFPCIMH;
    VirtualInvokeData OPDNANGDNBA;
    VirtualInvokeData HELNGMLCGJL;
    VirtualInvokeData NHJIJJOLMEE;
    VirtualInvokeData EMEGDBOLIHH;
    VirtualInvokeData FDFPNHPAABI;
    VirtualInvokeData KOALKPIIHLC_1;
    VirtualInvokeData CBEDOEMDNGI;
    VirtualInvokeData OEELOEPDKGG;
    VirtualInvokeData GANCEHAAHGL;
    VirtualInvokeData PLMALJEJCJF;
    VirtualInvokeData CMMGDIIIGAB;
    VirtualInvokeData NCJECNDGEIP;
    VirtualInvokeData EALGBFFCJEM;
    VirtualInvokeData IDENCFLPIDK;
    VirtualInvokeData JCJOFGGOBEF;
    VirtualInvokeData AFMFANKNNHE;
    VirtualInvokeData DPFEDLDBGEK;
    VirtualInvokeData NMANPJMGBKL;
    VirtualInvokeData FOBCACIDNKI;
    VirtualInvokeData FKGIOGJOEOP;
    VirtualInvokeData OLOPIGCHGKJ;
    VirtualInvokeData LAKBOKNLBDH;
    VirtualInvokeData COFINGEKPCF_1;
    VirtualInvokeData HJNJKPBHCIM;
    VirtualInvokeData GLBBEFGOFCL;
    VirtualInvokeData BCAOFLBEACH;
    VirtualInvokeData BFLMGMGAEOF;
    VirtualInvokeData ELNCEMGIIND_1;
    VirtualInvokeData PIPEKFIIDGD;
    VirtualInvokeData MPMABABIMCP;
    VirtualInvokeData GKGEJMCFPHI_1;
    VirtualInvokeData CLOIDEAKGJP;
    VirtualInvokeData NFLEEPAPKKP;
    VirtualInvokeData BBLFEAFHJKH_1;
    VirtualInvokeData DPCJEACICKK;
    VirtualInvokeData HPIBODLAOJC;
    VirtualInvokeData APEBBBLBCEJ;
    VirtualInvokeData LANFFOILAMN;
    VirtualInvokeData DKPABGHPOCJ;
    VirtualInvokeData NBKLEIKIGFN;
    VirtualInvokeData BMGEKIFPJHC;
    VirtualInvokeData OMHLFLLKCPK;
    VirtualInvokeData COAEKGLNEAL;
    VirtualInvokeData EHPALHBDILK_1;
    VirtualInvokeData POEKHBPFIDL;
    VirtualInvokeData AAHMOJNCAEK;
    VirtualInvokeData ANGKDDPHPFN;
    VirtualInvokeData IFIOEJGAPLJ;
    VirtualInvokeData OOOIFOEBDAJ;
    VirtualInvokeData MPDBHFCHDDH;
    VirtualInvokeData IBMMHKKOCBN;
    VirtualInvokeData AIHOPFLOCLP;
    VirtualInvokeData ICELADOIJBA;
    VirtualInvokeData JHPPPHIKPMG;
    VirtualInvokeData NEINEPBLPMH;
    VirtualInvokeData LPECJCAMEMP;
    VirtualInvokeData HNGNDEDKGCP;
    VirtualInvokeData CHMKLCOGDIP;
    VirtualInvokeData LOENKLMHINO;
    VirtualInvokeData EPMABIKKOML;
    VirtualInvokeData NIIFCJMKPNA;
    VirtualInvokeData BFDIMLPECPE;
    VirtualInvokeData PIOFJBCMOLO;
    VirtualInvokeData BIJBGHBEBPN;
    VirtualInvokeData DHAPLKNGOKH;
    VirtualInvokeData IOLPDIFPJDN;
    VirtualInvokeData PJIMKHBIKNJ;
    VirtualInvokeData AMJPDIBPFNK;
    VirtualInvokeData CNJNPCBLJCE_1;
    VirtualInvokeData JAANHPMMICC;
    VirtualInvokeData JHKEHOMNPIE;
    VirtualInvokeData JPKHLKPNLPP;
    VirtualInvokeData JPLLNFIICFA;
    VirtualInvokeData IMJPFNBICJA;
    VirtualInvokeData EEJAIAEFBOA;
    VirtualInvokeData HAPJPDKFCFD;
    VirtualInvokeData ACJHMKDHDIL;
    VirtualInvokeData HKHOBANJOBN;
    VirtualInvokeData JFKBIKLAOEH;
    VirtualInvokeData BPAMIGDFJNC;
    VirtualInvokeData NDAHNKAJJFO_1;
    VirtualInvokeData EOGNENLAAFI;
    VirtualInvokeData CBLGDBFAKDB;
    VirtualInvokeData MIHPMDAJABO;
    VirtualInvokeData JODCNNLPMPF;
    VirtualInvokeData DDNOEDGKAHH;
    VirtualInvokeData OABCFMOPODL;
    VirtualInvokeData DPKPBHOCFMB;
    VirtualInvokeData DIBLOODKAEL;
    VirtualInvokeData CHLLDAJHCLA;
    VirtualInvokeData AFMKFLLNPBG;
    VirtualInvokeData LOCNOABJDDG;
    VirtualInvokeData ILHJOIDIFMA;
    VirtualInvokeData NLAGEDGPPNE;
    VirtualInvokeData ECCDMCBOPBL;
    VirtualInvokeData JPKABBBFHJC;
    VirtualInvokeData LPNBFENLFPM;
    VirtualInvokeData JHPPBIBFPHE;
    VirtualInvokeData IFMKADLHOLP;
    VirtualInvokeData MDOIKABGJFB;
    VirtualInvokeData EGGIBLMIHON_1;
    VirtualInvokeData EOPBCALABJD;
    VirtualInvokeData EFMHDEMBBCO;
    VirtualInvokeData IJEDANMLOKH;
    VirtualInvokeData NOAINKEIHIN;
    VirtualInvokeData HOKDFHMCNBN;
    VirtualInvokeData BCPMACBKNNL;
    VirtualInvokeData BHPBLAEANLH_1;
    VirtualInvokeData NMAPJCLNANH;
    VirtualInvokeData BEIAEGHPNOO;
    VirtualInvokeData DGOLHGGGAIB;
    VirtualInvokeData HLEELDJDJEC_1;
    VirtualInvokeData FMCFLBMBKBN;
    VirtualInvokeData BOJFKGINKOL;
    VirtualInvokeData GDOBNNKHCGK;
    VirtualInvokeData CDKCIMLCDFB;
    VirtualInvokeData MCAPIBKFFHK;
    VirtualInvokeData KDMIIEIFNPI_1;
    VirtualInvokeData HCOBEKLMCCD;
    VirtualInvokeData NAFFBKLLEDD;
    VirtualInvokeData KCEIKKEHDHA;
    VirtualInvokeData KBPLGJIDCOK;
    VirtualInvokeData LGOJIJLDNKD;
    VirtualInvokeData FKIHKBAKAPJ;
    VirtualInvokeData IAHKGHELEJH;
    VirtualInvokeData EJBGEINNEBC_1;
    VirtualInvokeData PIOLCPPGNEE;
    VirtualInvokeData GDCMIMFBDED;
    VirtualInvokeData JFNAOCKGDAA;
    VirtualInvokeData GLNEHGOKHHG;
    VirtualInvokeData FPDJKCOPHJM;
    VirtualInvokeData LHOCMJILJHD;
    VirtualInvokeData HKHGMBBMFCM;
};

struct NIIFJAMEHDD__StaticFields {
};

struct NIIFJAMEHDD__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct NIIFJAMEHDD__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct NIIFJAMEHDD__VTable vtable;
};

struct NIIFJAMEHDD__Array__VTable {
};

struct NIIFJAMEHDD__Array__StaticFields {
};

struct NIIFJAMEHDD__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct NIIFJAMEHDD__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct NIIFJAMEHDD__Array__VTable vtable;
};

struct List_1_NIIFJAMEHDD___VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct List_1_NIIFJAMEHDD___StaticFields {
    struct NIIFJAMEHDD__Array *_emptyArray;
};

struct List_1_NIIFJAMEHDD___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct List_1_NIIFJAMEHDD___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct List_1_NIIFJAMEHDD___VTable vtable;
};
...
struct GJLIMCBOCJG__StaticFields {
    float MBHGNFOCOPA;
    struct Vector2 ABNPJNHOJCN;
    struct Vector2 IIIHPCBGCDO;
    struct float3 IEDHHLAHJLC;
    int32_t NKHOLOCOJCO;
    struct Vector2__Array *DJJPBANOMCJ;
};

struct GJLIMCBOCJG__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct GJLIMCBOCJG__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct GJLIMCBOCJG__VTable vtable;
};

struct LAAIPMHLFJN__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct LAAIPMHLFJN__StaticFields {
    struct Color BNOGEKBANJD;
    struct Color JFJBDIBMIBD;
    struct Color DACOPDFNNMO;
    int32_t OCIDKMOEIMI;
    float OKIGCHCKFLB;
    struct Vector2 HFIPICAPOBP;
    float GGFBCIFFDGD;
    float GPGHLLMBHEG;
    float DBPHPEPGBHG;
    struct List_1_List_1_EFBAFDICAFG_ *LFFGEDLFIJJ;
    struct Color32 HEIIBKGHNLP;
    struct Color32 MHDGDLEAJFB;
};

struct LAAIPMHLFJN__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct LAAIPMHLFJN__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct LAAIPMHLFJN__VTable vtable;
};

struct COEDKELBKMI__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
    ...
    VirtualInvokeData FGIMFPOACAC;
    VirtualInvokeData AOOJCNNGNGI;
    VirtualInvokeData BLECJOLCKGA;
    VirtualInvokeData LDNOCABHDNH;
    VirtualInvokeData NMJPMEHPDCH;
    VirtualInvokeData MEFFOIJMBON;
    VirtualInvokeData DHPIDDDNDHF;
    VirtualInvokeData ICAKOFGELOC;
    VirtualInvokeData HFKNELPFAKH;
    VirtualInvokeData KPCDLMEFDEG;
    VirtualInvokeData GOFAAPCAFLO;
    VirtualInvokeData GHKKLPJFHJP;
    VirtualInvokeData MKGJOCKCKAK;
    VirtualInvokeData KMENFFMFJBE;
    VirtualInvokeData BFHLLKGGKKN;
    VirtualInvokeData PPFIMGDBDBM;
    VirtualInvokeData PAJEALEAGIJ;
    VirtualInvokeData CNODPFDAMKP;
    VirtualInvokeData OLBDJDPMAFG;
    VirtualInvokeData GIABGEEGNBM;
    VirtualInvokeData KKIFKAJFPJM;
    VirtualInvokeData LDGKAJIBKJL;
    VirtualInvokeData EIGHAPKHNLD;
    VirtualInvokeData INKCOJMCNCL;
    VirtualInvokeData MEIKMMBKBKG;
    VirtualInvokeData DCJACGILLPL;
    VirtualInvokeData MPBHOBHPMBB;
    VirtualInvokeData GADFHOJCKJB;
    VirtualInvokeData HLEIOFECPMP;
    VirtualInvokeData KHGFJKLFIED;
    VirtualInvokeData CKNNAPNBKKN;
    VirtualInvokeData FLKMGGOOCAG;
    VirtualInvokeData EDFOEEHHCMI;
    VirtualInvokeData MDHIEHAPAEG;
    VirtualInvokeData JFNAOCKGDAA;
    VirtualInvokeData ANFGCAKNLOD;
    VirtualInvokeData JKJBGKBJCEG;
    VirtualInvokeData JJHDHBMFNJD;
    VirtualInvokeData CFOHFNGIOEA;
    VirtualInvokeData JDHPJGFKKMK;
    VirtualInvokeData KMIJCFNMAAE;
    VirtualInvokeData POGKGPFIAMD;
    VirtualInvokeData CGFJHKCACCI;
    VirtualInvokeData ADBOPJMKENH;
    VirtualInvokeData NHFOCGPGMEI;
    VirtualInvokeData CLBAPKENGOM;
};

struct COEDKELBKMI__StaticFields {
};

struct COEDKELBKMI__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct COEDKELBKMI__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct COEDKELBKMI__VTable vtable;
};

struct DAFEAHGLBGL__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
    ...
    VirtualInvokeData LHOCMJILJHD;
    VirtualInvokeData HKHGMBBMFCM;
    VirtualInvokeData BGLPMJFFPNJ;
    VirtualInvokeData HPICAMLPPIO;
    VirtualInvokeData PFGOAOHKHKL;
    VirtualInvokeData GPGKACLHOKA;
    VirtualInvokeData FDOBDPPHHJG;
    VirtualInvokeData NDJBALJKKPK;
    VirtualInvokeData FKOKEOONANG;
    VirtualInvokeData POJBJGABLKC;
    VirtualInvokeData CJDOJMIJNKB;
    VirtualInvokeData PPJDBEEBPKC;
    VirtualInvokeData NDCBCNDMDAC;
    VirtualInvokeData NPALFHGHMAN;
};

struct DAFEAHGLBGL__StaticFields {
    int32_t DLHELNJEEGG;
    int32_t OHDGDHPDNMI;
};

struct DAFEAHGLBGL__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct DAFEAHGLBGL__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct DAFEAHGLBGL__VTable vtable;
};
...
struct JFNHHLNJJKP__VTable {
    ...
    VirtualInvokeData NHFOCGPGMEI;
    VirtualInvokeData CLBAPKENGOM;
    VirtualInvokeData BBGECFOLBMO;
    VirtualInvokeData GOJDIFKKKFO;
    VirtualInvokeData MCHGGEIJMHD;
    VirtualInvokeData FJPJLDLBHOC;
    VirtualInvokeData GGJILNNAIKP;
    VirtualInvokeData CGBDKFAALDO;
    VirtualInvokeData MPKEFDMEHIM;
    VirtualInvokeData ABOOPMOBJFL;
    VirtualInvokeData MJJFHFMJLKN;
    VirtualInvokeData PALIHLGMNOE;
    VirtualInvokeData CEJFJEHKBCO;
    VirtualInvokeData PDJLNLFLDEM;
    VirtualInvokeData DACAJDGLFCP;
    VirtualInvokeData CPFNAMFLLEP;
    VirtualInvokeData GKDHOBOJEOD;
    VirtualInvokeData MMBMKLDFELA;
    VirtualInvokeData DBMNMGPFDOB;
    VirtualInvokeData JIMBGGKPMJP;
    VirtualInvokeData DFPOBJDPKJA;
    VirtualInvokeData AHHMDJAJLJJ;
};

struct JFNHHLNJJKP__StaticFields {
    float LIAMCFNBJGE;
    int32_t GOLICMPBJDH;
    struct float3 EIJCNOJNHBF;
    struct float3 GOMFPOBBPEN;
    struct Color32 PJEBOLPIEEB;
    struct Color32 OMGLAGPABBH;
    struct Color32 MPOEDALCEKH;
    struct Color32 HBAJDFHGIKH;
    struct Color32 KFLHLPGIMKB;
    struct Color ECGIFCANPCL;
    struct String *OBANGPLCNCJ;
    struct String *IDGIKPDMHJA;
    struct String *LFNHLIBBKOB;
    struct String *DCFHOFEGMIJ;
    struct String *BKBBBGKAKPP;
    struct String *HDDHDHJLEEO;
    struct String *GJHDAKKDIKK;
    struct String *NAFLHAPAFCM;
    struct Color32 ALBCFJLECDK;
    struct Color32 BDOEGABAMEI;
    struct Color32 PGOBDHLOAEH;
    struct Color32 PMNKPHBIKKL;
    struct Color32 EEBEBOGBKAL;
    struct Color32 OLLNGBIBBKO;
    struct Color32 JCLMDMGKFEF;
    struct Color32 EKMIFALOPGG;
    int32_t BAIDCIHKENH;
    int32_t NDAEIHJCGMI;
    int32_t DFPABKEPFFP;
    float LOKBCNMNIDN;
    ...
    bool FKKOILFPGPO;
    bool PIIMEKCCFFJ;
    struct List_1_UnityEngine_Vector2_ *GIHLHMJPHIJ;
    struct Color LNMMENLBGDJ;
    struct Color DFGBHJKBODN;
};

struct JFNHHLNJJKP__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct JFNHHLNJJKP__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct JFNHHLNJJKP__VTable vtable;
};
...
struct ApplicationManager__Fields {
    ...
    struct DKMLMKFGPCC *_HOKMJBEGNCK_k__BackingField;
...
struct MonoSingleton_1_DecaGames_RotMG_Managers_ApplicationManager___VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct MonoSingleton_1_DecaGames_RotMG_Managers_ApplicationManager___StaticFields {
    struct ApplicationManager *HDBMIAOIJNP;
    bool CMJNCMGDIMC;
};

struct MonoSingleton_1_DecaGames_RotMG_Managers_ApplicationManager___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct MonoSingleton_1_DecaGames_RotMG_Managers_ApplicationManager___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct MonoSingleton_1_DecaGames_RotMG_Managers_ApplicationManager___VTable vtable;
};

struct ApplicationManager__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct ApplicationManager__StaticFields {
    struct FEAAEPBNOGA__Enum__Array *ICIMDMLCJCB;
    bool DisableAssetsParsingOnStartup;
};

struct ApplicationManager__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct ApplicationManager__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct ApplicationManager__VTable vtable;
};
...
struct UnityThread__StaticFields {
    int32_t LDEKLLNFJIP;
    struct Queue_1_System_Action_ *OCGCIHBMBLC;
};

struct UnityThread__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct UnityThread__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct UnityThread__VTable vtable;
};
} // end namespace app